    ...
    <div class="container">
        ...
        <div class="row2">
            ...
            <div class="flipkart-navbar-search smallsearch col-sm-6 col-xs-11">
                <div class="row">
                    <input class="flipkart-navbar-input col-xs-11" style="color: black" type="text"
                           placeholder="Search Here ..." name="">
                    <button class="flipkart-navbar-button col-xs-1 button_1" type="submit">
            ...
            <div class="cart largenav col-sm-2">
                <a class="cart-button" href="/admin">
        ...
        <div class="container-fluid">
            <center>
                <div class="col-lg-9 col-sm-offset-3">
                    ...
                    <ul class="nav navbar-nav" style="width: 500px;margin-bottom: 5px">
                        <li class="active btn-danger"><a href="/">Home</a></li>

                        @foreach($directories as $directory)
                            <li class="dropdown btn-danger" style="margin-left: 3%"><a
...
<div class="container">
    ...
    <div class="row" style="background-color:#f1f6cb; padding-left: 5px;">
